...
export default function MainStore() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white font-sans selection:bg-orange-500 selection:text-white pb-32 md:pb-20 relative">
      ...
      {/* Hero Section - Homepage overhaul: bright gradient, 72px touch targets, mobile-first */}
      <section ref={heroRef} className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-orange-500 py-24 md:py-32 text-white text-center z-10">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 justify-center mb-16">
            <Link
              href="/36hr-trial"
              className="cta-hero bg-orange-500 hover:bg-orange-600 text-white font-bold py-8 px-12 text-2xl rounded-2xl shadow-2xl min-h-[72px] flex items-center justify-center transition-all hover:-translate-y-2"
            >
              <Gift className="w-6 h-6 mr-2" aria-hidden="true" />
              Start 36hr Trial
            </Link>
            <Link
              href="/jailbroken-fire-sticks"
              className="cta-hero bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-8 px-12 text-2xl rounded-2xl shadow-2xl min-h-[72px] flex items-center justify-center transition-all hover:-translate-y-2"
            >
      ...
      {/* Benefits Grid - Homepage overhaul: white section for contrast */}
      ...
      {/* Final CTA - Homepage overhaul: emerald band */}
      <section className="py-32 bg-gradient-to-r from-emerald-500 to-green-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <Link
            href="/36hr-trial"
            className="cta-hero bg-orange-500 hover:bg-orange-600 text-white font-bold py-8 px-20 text-2xl rounded-2xl shadow-2xl inline-flex items-center justify-center min-h-[72px] transition-all hover:-translate-y-2"
          >
            <Gift className="w-6 h-6 mr-2" aria-hidden="true" />
