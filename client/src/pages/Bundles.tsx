...
const TITLE = "Best Value: Device + Reloaded Fire TV Bundle";
const DESC = "Device with Reloaded Fire TV access. Everything you need to start streaming.";

const FAQ = [
  {
    question: "What is included in a bundle?",
    answer: "A bundle combines a device with Reloaded Fire TV access so you have the hardware and service path together in one purchase flow.",
  },
  {
...
export default function Bundles() {
  useEffect(() => {
    setPageMeta({
      title: "Reloaded Fire TV + Device Bundle | StreamStickPro",
      description: DESC,
      path: "/bundles",
    ...
    setMeta("og:title", "StreamStickPro Device + Reloaded Fire TV Bundle", true);
    setMeta("og:description", "Get the ultimate streaming package: device + Reloaded Fire TV access.", true);
    setMeta("og:image", "https://streamstickpro.com/images/bundle-og.webp", true);
    setMeta("twitter:card", "summary_large_image");
    setMeta("twitter:title", "StreamStickPro Device + Reloaded Fire TV Bundle");
    setMeta("twitter:description", "Get the ultimate streaming package: device + Reloaded Fire TV access.");
      ...
      <PillarLayout title={TITLE} description={DESC} breadcrumbs={breadcrumbs}>
        ...
        <section className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8">
          ...
          <p className="text-gray-300 mb-4">
            Bundles are designed for customers who want the clearest purchase path: choose a device with Reloaded Fire TV and pair it with service access so you can move from checkout to streaming with less friction.
          </p>
        ...
        <section className="mt-8 grid gap-4 md:grid-cols-3">
          <Link href="/iptv">
            <a className="rounded-2xl border border-white/10 bg-white/5 p-5 text-white hover:border-cyan-400 transition-colors">View Reloaded Fire TV Plans</a>
          </Link>
          <Link href="/devices">
