...
const PRICING_FAQ = [
  ...
  { question: "Can I try before I buy?", answer: "Yes. StreamStickPro offers a separate 36-hour trial request for subscription plans so you can test the service before buying a paid plan." },
  { question: "What is the best value Reloaded Fire TV plan?", answer: "The 1-year plan starts at $65 for 1 device and offers the best per-month rate. Multi-device yearly pricing varies by device count, and the live shop pricing is the source of truth." },
