    ...
    <div className={`flex flex-wrap items-center justify-center gap-6 ${className}`}>
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm">
          ...
          <span className="text-gray-400 ml-1">Happy Customers</span>
        </span>
      </div>
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm">
          ...
          <span className="text-gray-400 ml-1">Satisfaction Rate</span>
        </span>
      </div>
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm">
          ...
          <span className="text-gray-400 ml-1">Based Support</span>
        </span>
      </div>
    </div>
  );
