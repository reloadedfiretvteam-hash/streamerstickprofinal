...
export function MobileNav({ scrollToShop, scrollToFaq, onSupportClick }: MobileNavProps) {
      ...
      <SheetContent side="left" className="w-[300px] bg-[#0A0A0F] border-r border-[#2A2A33] p-0">
        ...
        <nav className="p-4">
          ...
          <div className="mt-6 p-4 bg-gradient-to-br from-cyan-500/15 to-emerald-500/10 rounded-lg border border-cyan-400/30">
            ...
            <p className="text-xs text-gray-300">Use the sticky buttons below the page for Start Trial and Shop Devices.</p>
          </div>
        </nav>
      </SheetContent>
    </Sheet>
