...
import { Gift, Mail, User, Loader2, Check, Clock } from "lucide-react";
...
export function FreeTrial() {
  ...
  return (
    <motion.div 
      ...
      className="max-w-2xl mx-auto mb-12 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-2 border-purple-500/50 rounded-2xl p-8"
    ...
    >
      ...
      <div className="flex items-center gap-2 text-gray-300 mb-6">
        ...
        <span>Try our premium IPTV service FREE for 36 hours - experience 18,000+ channels!</span>
      </div>
