...
SELECT
  ...
  true,
  1
WHERE NOT EXISTS (SELECT 1 FROM stripe_products LIMIT 1);
...
SELECT
  ...
  true,
  2
WHERE NOT EXISTS (SELECT 1 FROM stripe_products WHERE name = 'Content Strategy & Research Package - 3 Months');
...
SELECT
  ...
  true,
  3
WHERE NOT EXISTS (SELECT 1 FROM stripe_products WHERE name = 'Premium Digital Media Library Access - 6 Months');
...
SELECT
  ...
  true,
  4
WHERE NOT EXISTS (SELECT 1 FROM stripe_products WHERE name = 'Enterprise Content Management & Research Platform - 1 Year');
...
SELECT
  ...
  true,
  5
WHERE NOT EXISTS (SELECT 1 FROM stripe_products WHERE name = 'Professional Website Page Design & Development');
...
SELECT
  ...
  true,
  6
WHERE NOT EXISTS (SELECT 1 FROM stripe_products WHERE name = 'Website Page Design + 1 Month SEO Optimization');
...
SELECT
  ...
  true,
  7
WHERE NOT EXISTS (SELECT 1 FROM stripe_products WHERE name = 'Website Page Design + 6 Months SEO Strategy');
